...
function customSet(arr) {
  var set = new Set(arr); // Створити множину з масиву

  for (let element of set) {
    // Перебрати всі елементи множини
    if (typeof element === "number") {
      // Перевірити, чи є елемент числом
      set.delete(element); // Видалити числовий елемент з множини
    }
  }

  return set; // Повернути множину, що містить лише рядкові елементи
...
function clearSet(set) {
  if (set.size > 0) {
    // Перевірка, чи множина не є порожньою
    set.clear(); // Очистити множину за допомогою методу clear()
